...
Usage
  ...
  # adjust DBSCAN
  python main.py --synthetic --dbscan-eps 0.4 --dbscan-min-samples 4
"""
...
def run(args: argparse.Namespace) -> None:
    ...
    if args.synthetic:
        log.info(
            "generating synthetic dataset: n_normal=%d  n_clusters=%d  n_days=%d",
            args.n_normal, args.n_clusters, args.n_days,
        )
    ...
    # ── 8. Optional precision/recall against ground truth ────────────────────
